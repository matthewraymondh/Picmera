...
const CreatePin = ({ user }) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
      {fields && (
        <p className="text-cyan-500 mb-5 text-xl transition-all duration-150 ease-in">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex justify-end items-end mt-5">
              <button
                type="button"
                onClick={savePin}
                className="bg-cyan-500 text-white font-bold p-2 rounded-full w-28 outline-none"
              >
                Save Pin
              </button>
            </div>
